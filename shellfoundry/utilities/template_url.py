...
def construct_template_url(repo_address: str, branch: str) -> str:
    branch = branch or ""
...
def _try_parse_git_url(url: str) -> tuple[bool, str | None, str | None]:
...
def _try_parse_http_url(url: str) -> tuple[bool, str | None, str | None]:
...
def _join_url_all(url: str, fragments: list[str]) -> str:
